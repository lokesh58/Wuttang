...
static void addWhitePawnCapMove(const Position &pos, const int from,
                                const int to, const int cap, Movelist &list) {
...
static void addWhitePawnMove(const Position &pos, const int from, const int to,
                             Movelist &list) {
  assert(SqOnBoard(from));
  assert(SqOnBoard(to));
...
static void addBlackPawnCapMove(const Position &pos, const int from,
                                const int to, const int cap, Movelist &list) {
  assert(PieceValid(cap));
  assert(SqOnBoard(from));
  assert(SqOnBoard(to));
...
static void addBlackPawnMove(const Position &pos, const int from, const int to,
                             Movelist &list) {
  assert(SqOnBoard(from));
  assert(SqOnBoard(to));
