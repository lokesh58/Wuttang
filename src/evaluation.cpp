...
const int KnightTable[64] = {
    -10, -30, -10, -10, -10, -10, -30, -10, -10, 0,   0,   0,   0,
...
const int BishopTable[64] = {
    -10, -10, -20, -10, -10, -20, -10, -10, -10, 0,   0,   0,   0,
    0,   0,   -10, -10, 0,   5,   5,   5,   5,   0,   -10, -10, 0,
    5,   10,  10,  5,   0,   -10, -10, 0,   5,   10,  10,  5,   0,
    -10, -10, 0,   5,   5,   5,   5,   0,   -10, -10, 0,   0,   0,
    0,   0,   0,   -10, -10, -10, -10, -10, -10, -10, -10, -10};

const int KingE[64] = {0,  10, 20, 30, 30, 20, 10, 0,  10, 20, 30, 40, 40,
                       30, 20, 10, 20, 30, 40, 50, 50, 40, 30, 20, 30, 40,
                       50, 60, 60, 50, 40, 30, 30, 40, 50, 60, 60, 50, 40,
                       30, 20, 30, 40, 50, 50, 40, 30, 20, 10, 20, 30, 40,
                       40, 30, 20, 10, 0,  10, 20, 30, 30, 20, 10, 0};

const int KingO[64] = {0,   20,  40,  -20, 0,   -20, 40,  20,  -20, -20, -20,
...
const int endgame_mat =
    pceVal[wR] + 2 * pceVal[wN] + 2 * pceVal[wP] + pceVal[wK];
